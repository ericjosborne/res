# Paid family leave: mothers' labour supply (CPS) and parents' mental health (NSCH)
...
* `docs/results.md` – results with tables and figures (`../results.html` at the repository root is the page version, with the NSCH and minimum wage parts).
...
All commands run from this directory (`pfml/`); Stata's `00_master.do` takes the working directory as the project root.
...
docs/     research_design.md  results.md  nsch_design.md  nsch_results.md  brfss_design.md (parked)
```
