...
02_csdid.py runs on either.

Input : data/raw/cps_NNNNN.csv (or ipums_cps_asec.csv.gz)
Output: data/clean/cps_asec_women_1844.csv.gz and .dta (Stata 16)
...
def find_extract():
    ...
    if not found:
        raise FileNotFoundError("no IPUMS extract in data/raw (see IPUMS_EXTRACT_SPEC.md)")
    return found[-1]
