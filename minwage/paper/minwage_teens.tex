...
Table~\ref{tab:groupsreg} gives the stacked difference-in-differences coefficients of Section~\ref{sec:reg}, one post-event average per share and age. They reproduce the event-study averages of Table~\ref{tab:groups}: $-0.1$ points (s.e.\ 0.4) for enrolled-and-employed at 16--17 and $+0.4$ (0.5) at 18--19, $-0.0$ (0.5) and $-0.6$ (0.6) for enrolled only, $+0.3$ (0.2) and $+0.5$ (0.6) for employed only, $-0.2$ (0.3) and $-0.3$ (0.4) for neither, and nothing beyond about one standard error from zero for any share or age. The two-way fixed effects regression of the earlier literature, reported in Appendix~\ref{app:twfe}, agrees with these estimates in school months and departs from them only when the summer months, in which the enrollment item records summer school, are included.
