...
The paper contributes to three literatures. To the work on minimum wages and schooling \citep{ehrenberg1982,neumark1995a,neumark1995b,neumark2003,chaplin2003,campolieti2005,warren2010,smith2021}, it adds the first estimates from an event design with clean controls, on the largest increases in the modern era, with local minimums treated as the policies they are. The closest paper is \citet{smith2021}, who finds in CPS, SIPP and ACS data for 1992--2012 that a 10 percent rise in the state minimum lowers high school dropout among teens whose parents lack a diploma by 0.5 to 1.0 points, with no effect on other teens, using two-way fixed effects with state trends, a within-commuting-zone border comparison, and a distributed-lag specification in the manner of \citet{dube2010}. Section~\ref{sec:ses} takes his outcome and his socioeconomic split to the 2010--2025 increases with the event design. To the debate over the decline in teen employment \citep{morisi2008,smith2011,smith2012,neumark2019}, it adds a direct test of the minimum wage explanation that finds no support for it: the minimum wage raised the pay of teens who worked and did not change how many of them worked. To the event-study literature on minimum wages \citep{cengiz2019,dube2019,clemens2019}, it extends the no-disemployment finding to the extensive margin for teenagers, the group for whom the minimum binds most tightly, and to the schooling margin. An earlier version of this project used contiguous-county pairs and two-way fixed effects and found small positive enrollment effects; the event design replaces both the identification and the conclusion.
