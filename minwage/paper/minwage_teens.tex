...
The stacked coefficients in Table~\ref{tab:groupssesreg} repeat the pattern within each income group. No coefficient is significant at the 5 percent level; the largest is employed-only among high-income 16--17 year olds, $+0.5$ points (s.e.\ 0.3), and the neither share changes by $-0.3$ (0.5) for low-income and $-0.2$ (0.3) for high-income 16--17 year olds.
...
The stacked coefficients for the wage (Table~\ref{tab:wagereg}) are 5.0 percent (s.e.\ 0.8) at 16--17, 3.2 (0.8) at 18--19 and 4.0 (0.7) pooled, next to the event-study averages of 5.3, 3.0 and 3.8; for weekly earnings they are 5.4 (2.5), 4.8 (1.5) and 5.5 (1.5). The two-way fixed effects elasticity of the teen wage with respect to the minimum, in Appendix~\ref{app:twfe}, is about 0.2 at every age, which for the average event implies gains of 5 to 7 percent. Where the treatment has a real effect the designs agree in sign and roughly in size.

\begin{table}[H]
\centering
\caption{Stacked difference-in-differences estimates for teen wages and earnings, 73 events from 2010}
\label{tab:wagereg}
\small
