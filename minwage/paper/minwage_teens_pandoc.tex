...
\begin{table}
\centering
\caption{Table 1: Means in the year before the event, 73 unit events from 2010: event units and clean controls}
...
\noindent\small Notes: Weighted means over the twelve months before each event, pooled across the 73 events; event units are the treated county or state remainder, controls the clean control units of that event. Hourly wage among hourly-paid workers in the outgoing rotation groups, earnings-weighted.
